...
export default function DocumentPage() {
  ...
  }, [docId, userName, selectedPatient]);
  ...
  const [items] = useState([
    { title: 'Algemas para consulta', content: 'Informações úteis para a consulta de forma simples e clara.' },
    { title: 'Preparação do paciente', content: 'Passos para preparação do paciente antes da consulta.' },
    { title: 'Observações', content: 'Espaço para anotações diversas e observações do médico.' },
  ]);
  ...
  /* ===== ARQUIVAR PACIENTE (limpando seleção compartilhada) ===== */
      ...
      <header className="bg-white py-6 shadow-sm border-b">
        <div className="container mx-auto px-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            ...
            <ProfileSelector profile={userProfile} setProfile={setUserProfile} />
          </div>
        </div>
      </header>
